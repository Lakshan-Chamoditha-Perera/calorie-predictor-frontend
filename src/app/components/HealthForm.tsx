...
import { FileText, User, Users, Ruler, Scale, Clock, Heart, Thermometer, Activity, X, Check, Calculator } from 'lucide-react'
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                                {mutation.isPending && (
                                    <div className="flex items-center justify-center py-8">
                                        <div className="flex items-center gap-3 text-blue-600">
                                            ...
                                            <span className="text-lg font-medium">Calculating calories burned...</span>
                                        </div>
                                    </div>
                                )}
                                    ...
                                    <div className="flex items-center justify-center py-8">
                                        <div className="flex items-center gap-3 text-red-600">
                                            ...
                                            <span className="text-lg font-medium">
                                                {(mutation.error as any)?.response?.data?.message || 'Failed to calculate calories'}
                                            </span>
                                        </div>
                                    </div>
                                )}
                                ...
                                {!mutation.isPending && !mutation.isError && caloriesBurned === null && (
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                ...
                                className={`px-8 py-3 bg-blue-600 text-white font-medium rounded-lg transition-colors duration-200 ${mutation.isPending
                                    ? 'opacity-50 cursor-not-allowed'
                                    : 'hover:bg-blue-700'
                                    }`}
                            >
                                {mutation.isPending ? 'Calculating...' : 'Calculate Calories'}
                            </button>
                        </div>
                    </form>
                </div>
